...
# Selector de División (Fuera del formulario para que sea reactivo)
...
with st.form("registro_total"):
    ...
    # Selector Dinámico de Planes (Basado en la división seleccionada)
    ...
    # Cálculo manual de descuento[cite: 1]
    ...
    if st.form_submit_button("💾 Guardar Registro en Base Central"):
        ...
        st.success("✅ Venta registrada con éxito según portafolio[cite: 1].")
